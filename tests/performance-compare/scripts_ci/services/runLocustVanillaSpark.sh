...
if [ $# -ne 8 ];then
        echo "Usage: ./runLocustVanillaSpark.sh sqls_home private_namenode_ip iteration result_dir private_driver_host locust_home spark_home emr_user"
        exit 1
fi

#bash ./runLocustVanillaSpark.sh /home/ubuntu/glutenTest/sqls/query 172.31.17.38 1 /home/ubuntu/glutenTest/result/VanillaSpark_2022_11_16_16_13_24 172.31.23.71 /home/ubuntu/glutenTest/locust /home/ubuntu/glutenTest/spark/spark-3.2.2-bin-hadoop2.7 ec2-user
