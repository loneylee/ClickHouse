...
ansible --key-file ${key_file} driver -m shell -a "mysql -h 127.0.0.1 -P9030 -uroot -e 'drop database if exists tpch100 FORCE;drop database if exists tpch1000 FORCE;'"
